...
class SendInBlueTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function sendTemplateEmail_calls_correct_methods()
    {
        ...
        $emailMessage = (new EmailTemplatedMessage())
            ->setTemplate('temp1')
            ->addToEmailAddress('test1@example.com', 'test1')
            ->addToEmailAddress('test2@example.com', 'test2')
            ->addCcEmailAddress('cc@example.com', 'cc')
            ->addBccEmailAddress('bcc@example.com', 'bcc')
            ->setSubject('set subject')
            ->setReplyToEmailAddress('replay-to@example.com')
